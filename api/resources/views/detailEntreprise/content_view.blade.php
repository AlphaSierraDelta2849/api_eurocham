@php
    ...
    $has_avatar = $entreprise->hasAvatar();
    $avatar = $has_avatar ? $entreprise->avatar : Util::getDefaultUserAvatar();
@endphp
<!--begin::Content-->
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="d-flex flex-column flex-xl-row">
            @include('detailEntreprise.fiche_user_item')
            <!--begin::Content-->
            <div class="flex-lg-row-fluid ms-lg-15">
                @include('detailEntreprise.nav_menu')
                <!--begin:::Tab content-->
                <div class="tab-content" id="myTabContent">
                    @include('detailEntreprise.content.overview')
                    @include('detailEntreprise.content.general_settings')
                    @include('detailEntreprise.content.security_settings')
                </div>
                <!--end:::Tab content-->
            </div>
            <!--end::Content-->
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                            ...
                            <div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
                                <img src={{ URL::asset('assets/media/misc/qr.png') }} alt="Scan this QR code" />
                            </div>
                            <!--end::QR code-->
                            <!--begin::Text code-->
