@php
    ...
    $posts = Post::where('user_id', $entreprise->id)->get();
                ...
                <div class="card-body pt-0">
                    <div class="fw-bold fs-2">
                        ...
                        <div class="fs-7 fw-normal text-muted">
                            A la fin de chaque post, vous serez noté.
                        </div>
                    </div>
                </div>
                <!--end::Card body-->
    ...
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-header border-0">
            ...
            <div class="card-title flex-column">
                ...
                <br>
                <h4 class="card-subtitle">{{ $posts->count() }} Publication(s)</h4>
            </div>
            <!--end::Card title-->
        </div>
        <!--end::Card header-->
            ...
            <table class="table align-middle table-row-dashed gy-5" id="table_liste_expeditions">
                ...
                <thead class="border-bottom border-gray-200 fs-7 fw-bold">
                    ...
                    <tr class="text-start text-muted text-uppercase gs-0">
                        <th class>ID</th>
                        <th>titre</th>
                        <th class="min-w-100px">Date de publication</th>
                ...
                <tbody class="fs-6 fw-semibold text-gray-600">
                        @foreach ($posts as $post)
                            ...
                            <tr>
                                ...
                                <!--begin::Status=-->
                                <td>
                                    <span class="badge badge-light-success">{{ $post->titre }}</span>
                                </td>
                                <!--end::Status=-->
                                <!--begin::Amount=-->
                                <td data-order="{{$post->created_at}}">{{ $post->created_at }}
                                </td>
                                <!--end::Amount=-->
                                <!--begin::Date=-->
                                <td>
